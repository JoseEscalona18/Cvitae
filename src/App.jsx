...
function App() {
  return (
    <>
    <header className='flex flex-col justify-center items-center text-center mt-5'>
      <ul className='flex gap-5 text-white bg-blue-900/15 px-3 py-1 rounded-full'>
    ...
    <section>
      <div className='flex flex-col justify-center items-center text-center mt-10'> 
        <div className="w-40 h-40 rounded-full overflow-hidden mb-4 shadow-2xl shadow-blue-500/20">
          <img src="../public/yo.webp" alt="Foto José" className="w-full h-full object-cover" />
        </div>
        <h1 className='text-white font-bold text-4xl'>José A. Escalona G.</h1>

        <ul className='flex flex-row gap-5 mt-5'>
          <li>
            <a href="https://www.facebook.com/escalonajag?mibextid=ZbWKwL">
          ...
          <li>
            <a href="https://www.instagram.com/escalonajag" className="flex items-center">
          ...
          <li>
              <a href="https://wa.me/584120104910">
